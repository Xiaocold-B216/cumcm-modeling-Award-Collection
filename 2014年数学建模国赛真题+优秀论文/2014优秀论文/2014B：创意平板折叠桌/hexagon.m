...
for theta=the
        ...
        X=xishu*[1/2*BoardWidth 0]+EdgeLength*1/2;Y=[0 1/2*BoardWidth];Z=[0 0];
        plot3(X,Y,Z)
        hold on
        X=xishu*[0 -1/2*BoardWidth]-EdgeLength*1/2;Y=[1/2*BoardWidth 0];Z=[0 0];
        plot3(X,Y,Z)
        hold on
         X=xishu*[-1/2*BoardWidth 0]-EdgeLength*1/2;Y=[0 -1/2*BoardWidth];Z=[0 0];
        plot3(X,Y,Z)
        ...
        hold on
         ...
         X=[-EdgeLength*1/2 EdgeLength*1/2];Y=[1/2*BoardWidth 1/2*BoardWidth];Z=[0 0];
        plot3(X,Y,Z)
        hold on
